...
-- Set up LSP servers. (reads the config from ../lsp)
-- (m.s.) see also https://gpanders.com/blog/whats-new-in-neovim-0-11/#lsp
-- (m.s.) to check status run `:checkhealth lsp`
...
-- -- (m.s.) - old configuration loaded from a single file
...
--     print('calling configure server')
--     local capabilities = vim.lsp.protocol.make_client_capabilities()
--     capabilities = require('blink.cmp').get_lsp_capabilities(capabilities)
--
--     require('lsp-config')[server].setup(vim.tbl_deep_extend('error', { capabilities = capabilities, silent = true }, settings or {}))
-- end
